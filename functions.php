        ...
        <div class="formWa" id="formWA">
            <div class="formWaBody" id="formWABody">
                <div class="heading clear">
                    <i class="fas fa-shopping-cart color-scheme-text"></i>
                ...
                <div id="cartEmpty" class="cart-empty">
                    <div class="cart-empty-inner">
                        ...
                        <p>
                            <a href="<?php echo site_url(); ?>/product/" class="color-scheme-background"><i class="fas fa-shopping-bag"></i> Belanja Sekarang !</a>
                        </p>
                    </div>
                </div>
    ...
    <div class="formWaBox" id="helpViaWa">
        <div class="formWa" id="formHelpWA">
            <div class="formWaBody" id="formHelpWABody">
                <div class="heading clear">
                    <i class="fab fa-whatsapp" style="color: #61ddbb"></i>
