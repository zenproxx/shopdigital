(function(w, d){
	...
	font.type = 'text/css';
	font.rel = 'stylesheet';
	font.href = 'https://fonts.googleapis.com/css?family=Roboto:400,700';

	b.appendChild(font);

	let icon = d.createElement('script');
	icon.async = true;
	icon.src = 'https://kit.fontawesome.com/a076d05399.js';
...
function loadCartItems(){
	...
	cartItems.forEach( function(item, i) {
		...
		appendItems += '<div class="item clear"><div class="thumb"><img src="'+item.order_item_photo+'" id="orderItemPhoto"/></div><div class="detailbox"><div class="detail"><h3>'+item.order_item_name+'</h3></div>'+varian+'<div class="optione clear"><div class="optione-price">'+main.currency.format(item.order_item_price)+'</div><div class="optione-qty"><div class="optione-qty-changer clear"><button type="button" class="minus" onclick="cartItemChangeQty(this,\'minus\');">-</button><input min="1" type="number" value="'+item.order_item_qty+'" name="order_item_qty" item_id="'+item.cart_id+'"><button type="button" class="plus" onclick="cartItemChangeQty(this,\'plus\');">+</button></div><i class="fas fa-trash color-scheme-text" onclick="deleteCartItem(\''+item.cart_id+'\');"></i></div></div></div></div>';
